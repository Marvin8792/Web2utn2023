...
export const obtenerFacturas = async (req: Request, res: Response): Promise<Response> => {
...
export const obtenerFactura = async (req: Request, res: Response): Promise<Response> => {
  const facturaRepository = AppDataSource.getRepository(Factura);
...
export const crearFactura = async (req: Request, res: Response): Promise<Response> => {
...
export const modificarFactura = async (req: Request, res: Response): Promise<Response> => {
  const { cliente, detalles } = req.body;
